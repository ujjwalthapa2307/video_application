...
window.addEventListener( 'load', () => {
    ...
    if ( !room ) {
        ...
        socket.on( 'connect', () => {
            ...
            //new user event received from new user
            socket.on( 'new user', ( data ) => {
                //server broadcasting thid newUserStart event to all connected clients
            ...
            //newUserStart will be received by specific client
        ...
        function init( createOffer, partnerName,senderUserName='' ) {
            ...
            pc[partnerName].ontrack = ( e ) => {
                ...
                if ( document.getElementById( `${ partnerName }-video` ) ) {
                    ...
                    controlDiv.id = "remote-username";
                    controlDiv.className = 'remote-name-controls';
                    controlDiv.innerHTML = `<br><h3 class="text-center text-secondary">${senderUserName!==''?senderUserName:'Anonymous'}</h3>`;
